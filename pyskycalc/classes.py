...
from .utils import altazparang,lpsidereal,lpmoon,lpsun,accumoon,min_max_alt,phase_descr
from .utils import ha_alt, jd_sun_alt, jd_moon_alt, local_midnight_Time, hrs_up
from .utils import ztwilight, lunskybright, true_airmass
from .utils import currentgeocentframe, currentFK5frame, thorconsts
from .utils import precessmatrix, cel2localmatrix, cel2xyz
from .utils import getbrightest, skyproject, angle_between
from .utils import time_rounded_to_minute

# import matplotlib.pyplot as plt   # for tests
import sys  # for tests
import os

class ObsSite :  # shell for now, MDM only.
...
#            print l
            ...
            sitedict[x[0]] = ObsSite(name = x[1], loc = loc, tzstr = x[3], tzstdabbr = x[4],
                tzdayabbr = x[5],
