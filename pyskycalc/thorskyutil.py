...
# utility routines for sidereal, moon phase, altaz, and
# so on translated from the C skycalc.  These supplement
# or end-run astropy routines that are time consuming and/or
# require web access..
...
def lpsidereal(time, location) :
   ...
   for all observing-planning purposes.  Wrote this because
   native astropy routines required downloading 3 MB of stuff
   from the USNO -- we don't need to be anywhere near that fussy.
   """
